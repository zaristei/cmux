...
// CLIRelayServer has been extracted to Sources/CLIRelayServer.swift
...
final class WorkspaceRemoteSessionController {
    ...
    private var cliRelayServer: CLIRelayServer?
    ...
    private func startReverseRelayLocked(remotePath: String) {
        ...
        reverseRelayRestartWorkItem?.cancel()
        reverseRelayRestartWorkItem = nil
        var relayServer: CLIRelayServer?
        do {
    ...
    private func ensureCLIRelayServerLocked(localSocketPath: String, relayID: String, relayToken: String) throws -> CLIRelayServer {
        if let cliRelayServer {
            return cliRelayServer
        }
        let relayServer = try CLIRelayServer(
            localSocketPath: localSocketPath,
            relayID: relayID,
